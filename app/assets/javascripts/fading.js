$(function (){
    // Commented out this code for later use.
    ...
    $('#logo h3').css('display', 'block');
    $('#logo h1').animate({ opacity: 0 }, 0);
    $('#logo h3').animate({ opacity: 0 }, 0);
    $('#logo h1').animate({ opacity: 1, right: "-10px" }, 2500);
    setTimeout(function() {
      $('#logo h3').animate({ opacity: 1, top: "-10px" }, 1000)
    }, 2500);
});
